...
private:
  ...
  ros::Subscriber var_command_sub_;
  tf::TransformListener listener_; 
  moveit_msgs::GetPlanningScene scene_srv_;
  ros::ServiceClient client_get_scene_;

  boost::shared_ptr<GaussianMixtureModel> _gaussian_mixture_model;
  // GaussianMixtureModel _gaussian_mixture_model;
...
public:
  ...
  void executeAction(const std_msgs::String msg);

  void laserObstacleCallback(const sensor_msgs::LaserScan msg);

  void executeCommand(const std_msgs::String msg);
